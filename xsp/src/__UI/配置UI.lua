...
主配置:addComboBox({id="刘海屏适配",list="不选择,红米note7(不显示刘海),红米note7(显示刘海),2244*1080,2248*1080,2280*1080,2340*1080,荣耀10(2280*1080),红米7",select=UIconfig.刘海,size=30,w=30,h=10})
--主配置:nextLine(1.2) 
