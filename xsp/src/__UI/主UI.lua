...
local 助战名单=助战名单.."闪闪,黑狗,源赖光,宫本武藏,刑部姬,天草四郎,弓凛,兰斯洛特(狂),彭忒西勒亚(CEO),葛饰北斋,斯卡蒂"
local 助战名单=助战名单..'阿比盖尔,水尼禄,黑贞,冲田总司,大英雄,水枪呆,枪凛,葛饰北斋'
local 礼装名单="无要求,学妹午餐,2030年的碎片,蒙娜丽莎,宇宙棱镜,万华镜,虚数魔术,"
local 礼装名单=礼装名单..'Gilgamesh in NY,闪耀于摩天楼之上,C·k·T,开演时间,复仇战'
...
主功能选择:addLabel({text="[闪闪祭]",size=60,align="center",w=90,color="255,0,0"})
主功能选择:nextLine()
